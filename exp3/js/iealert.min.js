...
(function ($) {
    ...
    $.fn.iealert = function (options) {
        var defaults = {
            support:"ie8",
            title:"Our experiment dosen't support IE",
            text:"To get the best experience doing the experiment we recommend that you upgrade to the chrome/firefox browser. To download a modern web browser click on the Upgrade button.",
            upgradeTitle:"Upgrade",
            upgradeLink:"http://www.google.cn/intl/zh-CN/chrome/",
            overlayClose:false,
            closeBtn: true
        };
